...
[Long-Context Foundation Model / arXiv 2025]  
...
[Paper](https://arxiv.org/abs/2501.08313) · [PDF](https://arxiv.org/pdf/2501.08313) · [Issues](https://github.com/StaryMoon/MiniMax-01-Unofficial/issues) · [Release](https://github.com/StaryMoon/MiniMax-01-Unofficial/releases)
...
<p align="center">
  <img src="assets/paper-preview.png" alt="MiniMax-01-Unofficial paper or project page preview" width="900">
</p>

<sub>Image source: public paper/project page screenshot, [Paper](https://arxiv.org/abs/2501.08313). Captured/organized on 2026-07-02. This repository is unofficial and is not affiliated with the paper authors.</sub>
...
| Venue / Source | Long-Context Foundation Model / arXiv 2025 |
| Focus | This repository organizes a PyTorch implementation for MiniMax-01: Scaling Foundation Models with Lightning Attention, focusing on million-token context modeling with lightning... |
...
This repository organizes a PyTorch implementation for **MiniMax-01: Scaling Foundation Models with Lightning Attention**, focusing on million-token context modeling with lightning attention and MoE scaling. The codebase is structured like a standard research repository so that model components, configuration files, scripts, and evaluation utilities can be extended independently.
...
```bash
git clone https://github.com/StaryMoon/MiniMax-01-Unofficial.git
cd MiniMax-01-Unofficial
python -m venv .venv
...
```python
import torch
from minimax_01_unofficial import ModelConfig, UnofficialModel, reconstruction_loss

config = ModelConfig(task="llm", hidden_dim=128, num_layers=2, num_heads=4)
...
```python
import torch
from minimax_01_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables | [arXiv paper](https://arxiv.org/abs/2501.08313) |
| Ablation study | Experiment / ablation sections | [arXiv paper](https://arxiv.org/abs/2501.08313) |
| Qualitative examples | Main paper figures and appendix | [arXiv PDF](https://arxiv.org/pdf/2501.08313) |
...
- Thanks to the authors of **MiniMax-01: Scaling Foundation Models with Lightning Attention** for the original research.
...
pytorch, unofficial-implementation, reproduction, llm, long-context, lightning-attention, moe, minimax
